...
public class TransferConfirm {
    ...
    public void Clicking3(ActionEvent actionEvent) {
        ...
        // تحميل نافذة تأكيد كلمة المرور مع تمرير بيانات الدفع
        ...
        try {
            ...
            confirmPassword.setPaymentDetails(username, str1, amount, str3, TransToCn.getText()); // تمرير بيانات الدفع + نوع الخدمة
            confirmPassword.getTxt(str1, str2, str3, username); // تمرير البيانات الأصلية
